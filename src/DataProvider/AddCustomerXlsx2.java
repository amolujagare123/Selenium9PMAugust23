...
import static DataProvider.util.ForDataProvider.readDataFromExcel;

public class AddCustomerXlsx2 {
    WebDriver driver;
    @BeforeClass
    public void doLogin()
    {
    ...
    Object[][] getData() throws IOException {
       ...
       return readDataFromExcel("Data/myDataxlsx.xlsx","customer data");
